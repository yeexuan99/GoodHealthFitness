...
class BMIFragment(value: Double, method:Int,  context: Context) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        fragmentView = inflater.inflate(R.layout.fragment_bmi, container, false)
        init()
        return fragmentView
    }
...
*/
        var bmi = fragmentView!!.findViewById<Button>(R.id.bmi_btn)
        var ffmi = fragmentView!!.findViewById<Button>(R.id.ffmi_btn)
        if (type == 0) {
            ...
            var underweight_count_tv: TextView? =
                fragmentView?.findViewById(R.id.underweight_count_tv)
            ...
            var overweight_count_tv: TextView? =
                fragmentView?.findViewById(R.id.overweight_count_tv)
            ...
            var severely_obese_count_tv: TextView? =
                fragmentView?.findViewById(R.id.severely_obese_count_tv)

            var very_severely_obese_tv: TextView? =
                fragmentView?.findViewById(R.id.very_severely_obese_tv)
            var very_severely_obese_count_tv: TextView? =
                fragmentView?.findViewById(R.id.very_severely_obese_count_tv)
            very_severely_obese_count_tv?.setText("< 40")

            bmi_count_tv?.setText(
            ...
            when (result) {
                in 0.0..18.5 -> {
                    underweight_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    underweight_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                ...
                in 18.5..25.0 -> {
                    normal_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    normal_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                ...
                in 25.0..30.0 -> {
                    overweight_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    overweight_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                ...
                in 30.0..35.0 -> {
                    obese_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    obese_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                ...
                in 35.0..40.0 -> {
                    severely_obese_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    severely_obese_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                ...
                in 40.0..Double.MAX_VALUE -> {
                    very_severely_obese_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
                    very_severely_obese_count_tv?.setTextColor(contexts.getColor(R.color.colorAccent))
        ...
        if (type == 1) {
            ...
            var underweight_tv: TextView? = fragmentView?.findViewById(R.id.underweight_tv)
            underweight_tv?.setText("Not Muscular")
            var underweight_count_tv: TextView? =
                fragmentView?.findViewById(R.id.underweight_count_tv)
            underweight_count_tv?.setText("> 22 ")

            var normal_tv: TextView? = fragmentView?.findViewById(R.id.normal_tv)
            normal_tv?.setText("")
            var normal_count_tv: TextView? = fragmentView?.findViewById(R.id.normal_count_tv)
            normal_count_tv?.setText("")

            var overweight_tv: TextView? = fragmentView?.findViewById(R.id.overweight_tv)
            overweight_tv?.setText("Muscular")
            var overweight_count_tv: TextView? =
                fragmentView?.findViewById(R.id.overweight_count_tv)
            overweight_count_tv?.setText("22 - 24")

            var obese_tv: TextView? = fragmentView?.findViewById(R.id.obese_tv)
            obese_tv?.setText("")
            var obese_count_tv: TextView? = fragmentView?.findViewById(R.id.obese_count_tv)
            obese_count_tv?.setText("")

            var severely_obese_tv: TextView? = fragmentView?.findViewById(R.id.severely_obese_tv)
            severely_obese_tv?.setText("Very Muscular")
            var severely_obese_count_tv: TextView? =
                fragmentView?.findViewById(R.id.severely_obese_count_tv)
            severely_obese_count_tv?.setText("> 24")

            var very_severely_obese_tv: TextView? =
                fragmentView?.findViewById(R.id.very_severely_obese_tv)
            very_severely_obese_tv?.setText("")
            var very_severely_obese_count_tv: TextView? =
                fragmentView?.findViewById(R.id.very_severely_obese_count_tv)
            very_severely_obese_count_tv?.setText("")
    ...
    fun getImageUri(inImage: Bitmap): Uri {
        ...
        var path =
            MediaStore.Images.Media.insertImage(contexts.contentResolver, inImage, "mybmi", null)
